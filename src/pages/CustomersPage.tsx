...
export function CustomersPage() {
  ...
  const [form, setForm] = useState({ customer_name: '', mobile: '', alternate_mobile: '', address: '', gstin: '', contact_person: '', notes: '' });
  ...
  const handleSave = () => {
    ...
    setShowForm(false); setForm({ customer_name: '', mobile: '', alternate_mobile: '', address: '', gstin: '', contact_person: '', notes: '' });
  };
      ...
      <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
        <div className="overflow-x-auto">
          <table className="erp-table">
            <thead><tr><th>Customer</th><th>Mobile</th><th>GSTIN</th><th>Vehicles</th><th>Total Sales</th><th>Total Qty (BRASS)</th><th>Outstanding</th><th>Status</th><th>Actions</th></tr></thead>
            <tbody>
              {filtered.map(c => {
          ...
          <div className="bg-white rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto animate-slide-in">
            ...
            <div className="p-5 space-y-4">
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div><span className="text-slate-500">GSTIN:</span> <span className="font-medium font-mono">{customerDetail.gstin || '—'}</span></div>
              </div>
            ...
            <div className="p-5 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input type="text" value={form.gstin} onChange={e => setForm({ ...form, gstin: e.target.value })} className="w-full px-3 py-2 border border-slate-300 rounded-lg text-sm" />
                </div>
                <div>
